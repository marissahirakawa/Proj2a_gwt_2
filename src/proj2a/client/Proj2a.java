...
public class Proj2a implements EntryPoint, ClickHandler
{
   ...
   Button submitChangeButton = new Button("Submit Change");
   boolean isAdd = true;
   ...
   public void onModuleLoad()
   {
	 ...
	 submitChangeButton.addClickHandler(this);
   ...
   public void onClick(ClickEvent e)
   {
	 ...
	 if (source == addStudentButton) {
		 ...
		 isAdd = false;
		 setupAddStudent(selectedStudent.first_name,selectedStudent.last_name,selectedStudent.major);
	 }
	 else if (source == submitChangeButton) {
   ...
   private void showStudents(String responseText)
   {
      ...
      table.addColumn(mnameCol, "Major");
   ...
   private void setupAddStudent(String fn, String ln, String maj)
   {
   	   mainPanel.clear();
	   ...
	   if (isAdd){
		   ...
		   addStudentPanel.add(submitChangeButton);
	   }
